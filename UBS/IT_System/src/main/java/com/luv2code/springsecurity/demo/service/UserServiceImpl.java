...
public class UserServiceImpl implements UserService {
	...
	public void save(CrmUser crmUser) {
		...
		user.setUserName(crmUser.getUserName()); // citizenshipNr
		...
		user.setRoles(Arrays.asList(roleDao.findRoleByName("ROLE_CUSTOMER_TRACKER"))); // herkese default customer chatter atanýr. bu sonra deðiþtirilecek.
